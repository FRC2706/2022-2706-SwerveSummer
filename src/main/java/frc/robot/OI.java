...
/**
 * Get XInput from the joystick
 * Three settings impact this:
 * 1. speedLimitFactor
 * 2. maxAccel
 * 3. driverController.getRightTriggerAxis()
 * 
 * @return adjusted X input
 */
    public static double getXDriveInput(){
        
        double speedLimitFactor = RobotContainer.drivetrain.speedLimitFactor.getDouble(1.0);

        // save the current input to previous value
        ...
        // note: getXDriveInput() is called every 20ms.
        ...
        // @note: limit the XInput by right trigger and/or speed limit factor
