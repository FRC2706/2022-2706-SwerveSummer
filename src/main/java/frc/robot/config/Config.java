...
public final class Config {
    ...
    //MK4_L1
    private static final Mk4SwerveModuleHelper.GearRatio DRIVE_RATIO = Mk4SwerveModuleHelper.GearRatio.L1;
    ...
    public static final double MK4_WHEEL_DIAMTER = DRIVE_RATIO.getConfiguration().getWheelDiameter();// 0.10033;

    //private static final double DRIVE_GEAR_REDUCTION = (14.0 / 50.0) * (25.0 / 19.0) * (15.0 / 45.0); // THIS IS FOR THE MK4_L1
    //Converted Drive Sensor Velocity unit: m/s
    private static final double DRIVE_GEAR_REDUCTION = DRIVE_RATIO.getConfiguration().getDriveReduction();
    private static final double DRIVE_SENSOR_POS_CONVERSION = Math.PI * MK4_WHEEL_DIAMTER / TICKS_PER_ROTATION * DRIVE_GEAR_REDUCTION;
    ...
    //Converted Steer Sensor Position unit: radians
    private static final double STEERING_GEAR_REDUCTION = DRIVE_RATIO.getConfiguration().getSteerReduction();
    public static final double STEERING_SENSOR_POS_CONVERSION = 2.0 * Math.PI / TICKS_PER_ROTATION * STEERING_GEAR_REDUCTION;

    private static final TalonFXInvertType INVERTED_DRIVE = DRIVE_RATIO.getConfiguration().isDriveInverted() 
                                                            ? TalonFXInvertType.Clockwise : TalonFXInvertType.CounterClockwise;
    public static final TalonFXInvertType INVERTED_FRONT_LEFT_DRIVE = INVERTED_DRIVE;
    public static final TalonFXInvertType INVERTED_REAR_LEFT_DRIVE = INVERTED_DRIVE;
    ...
    public static final TalonFXInvertType INVERTED_REAR_RIGHT_STEERING = INVERTED_STEERING;
